TS_IG_network_DMFM_Poi <- function(Ad_matrix, MCMC_iteration, Q_shape1, Q_shape2, lambda, M_max){
...
TS_IG_network_DMFM_NB <- function(Ad_matrix, MCMC_iteration, Q_shape1, Q_shape2, r, p, M_max){
...
TS_IG_network_DMFM_BNB <- function(Ad_matrix, MCMC_iteration, Q_shape1, Q_shape2, al_lam, a_pi, b_pi, M_max){
